...
def reaction_diffusion(
    ...
    r"""Define the reaction-diffusion PDE in the Fourier (kx, ky) space.
    ...
    Args:
        ...
        uvt: Fourier transformed solution vector at current time step.
        K22: The squared magnitudes of the Fourier wavevectors (kx, ky).
